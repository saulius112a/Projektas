namespace Eshop.Data.Migrations
{
    ...
    public partial class initial : DbMigration
    {
        ...
        {
            DropForeignKey("dbo.CategoryAttribute", "CategoryId", "dbo.Category");
            ...
            DropForeignKey("dbo.CategoryAttribute", "AttributeId", "dbo.Attribute");
            ...
            DropIndex("dbo.CategoryAttribute", new[] { "AttributeId" });
            DropIndex("dbo.CategoryAttribute", new[] { "CategoryId" });
            ...
            DropTable("dbo.CategoryAttribute");
